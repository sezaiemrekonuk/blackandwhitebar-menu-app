...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-primary text-white">
      {/* Floating Go to Website Link */}
      <Link
        to="/"
        className="fixed top-4 left-4 z-50 bg-accent/90 backdrop-blur text-primary px-4 py-2 rounded-lg hover:bg-accent transition-all duration-300 shadow-lg flex items-center gap-2 group"
      >
